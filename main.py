...
class MyWebBrowser():
    def __init__(self):
        ...
        self.window = QWidget()
        self.window.setWindowTitle("Navegador Belico")

        self.url_history = ["https://www.utm.mx/"]
        self.current_url_index = 0

        self.layout = QVBoxLayout()
        self.horizontal = QHBoxLayout()

        self.pixmap = QPixmap("grupo.jpg")
        self.icon = QIcon(self.pixmap)
        self.window.setWindowIcon(self.icon)

        self.url_bar = QLineEdit("https://www.utm.mx/")
        ...
        self.browser.setUrl(QUrl("https://www.utm.mx/"))
